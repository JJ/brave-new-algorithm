...
%
\author{Cecilia Merelo\inst{1}\orcidID{0000-0002-5902-0159} \and
Juan J. Merelo\inst{1}\orcidID{0000-0002-1385-9741} \and Mario Garc\'ia-Valdez
\inst{2} \orcidID{0000-0002-2593-1114}}
%
\authorrunning{C. Merelo et al.}
% First names are abbreviated in the running head.
% If there are more than two authors, 'et al.' is used.
%
\institute{University of Granada, Granada, Spain\\
  \email{ceciliamm@correo.ugr.es,jmerelo@ugr.es}
  \and
Tijuana Technological Institute, Tijuana, \email{mario@tectijuana.edu.mx}}
%
...
\keywords{Evolutionary algorithm  \and Metaheuristics \and Literary-inspired
  algorithms \and exploration/exploitation balance.}
\end{abstract}
